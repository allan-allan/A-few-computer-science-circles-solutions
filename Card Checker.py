...
def check(S): 
    ...
    if S_new.isdigit() is False:                                        # Second condition to check if the card number consists of digits
        return False
    ...
    if x%10 == 0:                                                        # Third condition to check if the sum of the digits is divisible by 10
        return True
    else:
        return False
